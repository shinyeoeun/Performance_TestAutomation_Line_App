...
from sticker.lagacy.IosStickerDeviceControlTest import IosStickerDeviceControlTest
...
class RunAllScript(object):
    ...
    def __init__(self):
        self.test_case_path = "."
        self.title = "Yuki SDK Automation Test Report-iOS (2.16.0.1297)"
    ...
    def run(self):
        ...
        test_suite.addTests(unittest.TestLoader().loadTestsFromTestCase(IosStickerDeviceControlTest))
        test_suite.addTests(unittest.TestLoader().loadTestsFromTestCase(IosStickerVerifyTest))
